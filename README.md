...
To get the calibrate logistic model, set the Kmin-Kmax combination in **inditek:amin** and relaunch it. The obtained logistic model in this 2nd round is the calibratedlogistic model. Rename INDITEKlogistic_global.mat from this 2nd round as INDITEKcaliblogistic_global.mat to plot results with **inditek_figures**

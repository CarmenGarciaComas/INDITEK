...
To get the outputs of the calibrated logistic model, set the Kmin-Kmax combination in i**nditek_main.m** and relaunch it. Rename the INDITEKlogistic_global.mat output file as INDITEKcaliblogistic_global.mat and plot results with inditek_figures.
